...
class Bacterialconsortium(Module):
	...
	def build_net_structure(self) -> PetriNet:
		...
		controller_0_net.add_place(Place("ACP_gene", [BlackToken()]))
		controller_0_net.add_place(Place("ACP_mrna"))
		controller_0_net.add_place(Place("ACP_protein"))
		...
		controller_0_net.add_transition(Transition("ACP_gene_transcription_1"))
		controller_0_net.add_transition(Transition("ACP_mrna_translation_1"))
		controller_0_net.add_transition(Transition("ACP_protein_degradation_1"))
		...
		bacterialconsortium_net.add_input("controller_compartment", "diffusion_Lac1_protein_1", MultiArc([Variable('x')]*4), notify=[controller_0_net])
		bacterialconsortium_net.add_input("target_compartment", "diffusion_Lac1_protein_2", MultiArc([Variable('x')]*4), notify=[target_0_net])
		bacterialconsortium_net.add_input("controller_compartment", "diffusion__3OC6HSL_molecule_1", MultiArc([Variable('x')]*4), notify=[controller_0_net])
		bacterialconsortium_net.add_input("target_compartment", "diffusion__3OC6HSL_molecule_2", MultiArc([Variable('x')]*4), notify=[target_0_net])
		bacterialconsortium_net.add_output("target_compartment", "diffusion_Lac1_protein_1", MultiArc([Variable('x')]*4), notify=[target_0_net])
		bacterialconsortium_net.add_output("controller_compartment", "diffusion_Lac1_protein_2", MultiArc([Variable('x')]*4), notify=[controller_0_net])
		bacterialconsortium_net.add_output("target_compartment", "diffusion__3OC6HSL_molecule_1", MultiArc([Variable('x')]*4), notify=[target_0_net])
		bacterialconsortium_net.add_output("controller_compartment", "diffusion__3OC6HSL_molecule_2", MultiArc([Variable('x')]*4), notify=[controller_0_net])
		...
		controller_0_net.add_input("ACP_gene", "ACP_gene_transcription_1", Value(dot))
		controller_0_net.add_input("ACP_mrna", "ACP_mrna_translation_1", Value(dot))
		controller_0_net.add_input("ACP_protein", "ACP_protein_degradation_1", Value(dot), notify=[bacterialconsortium_net.place('controller_compartment')])
		...
		controller_0_net.add_input("ACP_protein", "enzymatic_reaction_1", Value(dot), notify=[bacterialconsortium_net.place('controller_compartment')])
		...
		controller_0_net.add_output("ACP_gene", "ACP_gene_transcription_1", Value(dot))
		controller_0_net.add_output("ACP_mrna", "ACP_gene_transcription_1", Value(dot))
		controller_0_net.add_output("ACP_protein", "ACP_mrna_translation_1", Value(dot), notify=[bacterialconsortium_net.place('controller_compartment')])
		...
		target_0_net.add_output("GFP_mrna", "GFP_gene_transcription_1", MultiArc([Value(dot)]*2))

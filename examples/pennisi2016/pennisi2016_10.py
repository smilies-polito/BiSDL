...
class Pennisi2016(Module):
	...
	def build_net_structure(self) -> PetriNet:
		...
		hs_0_net.add_input("B_PRESENTING_molecule", "process_10", MultiArc([Value(dot)]*2), notify=[pennisi2016_net.place('victim')])
		hs_0_net.add_input("TH_ACTIVE_molecule", "process_10", MultiArc([Value(dot)]*2), notify=[pennisi2016_net.place('victim')])
		...
		hs_0_net.add_input("B_PLASMA_molecule", "process_12", Value(dot), notify=[pennisi2016_net.place('victim')])
		hs_0_net.add_input("ANTIGEN_molecule", "process_13", Value(dot), notify=[pennisi2016_net.place('victim')])
		hs_0_net.add_input("IGG_molecule", "process_13", MultiArc([Value(dot)]*5), notify=[pennisi2016_net.place('victim')])
		...
		hs_0_net.add_output("B_PLASMA_molecule", "process_12", Value(dot), notify=[pennisi2016_net.place('victim')])
